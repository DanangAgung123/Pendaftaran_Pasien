                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table class="table table-hover">
                                      ...
                                      {{-- @foreach ($jadwal->dokter as $dokter ) --}}
                                        <tbody>
